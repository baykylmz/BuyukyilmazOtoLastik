...
interface AuthContextType {
  ...
  user: { id: string; email: string; role: string; name: string; phone?: string; address?: string } | null;
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const [user, setUser] = useState<{ id: string; email: string; role: string; name: string; phone?: string; address?: string } | null>(null);
